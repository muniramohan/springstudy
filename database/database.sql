...
go
ALTER TABLE USER_PROFILES RENAME COLUMN AVATAR_URL TO AVATAR_IMAGE;
go
ALTER TABLE USER_PROFILES DROP COLUMN AVATAR_IMAGE;
go
ALTER TABLE USER_PROFILES Add COLUMN AVATAR_IMAGE BLOB;
